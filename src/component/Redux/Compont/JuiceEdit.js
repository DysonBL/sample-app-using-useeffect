...
import { PUT_PRODUCT} from "../Action/Action";
...
const JuiceEdit = () => {
    ...
    useEffect(()=>{
        ...
        const GET_PRODUCTS=()=>{    
            axios          
            .get(`http://localhost:3005/Juice/${Id}`)
            .then((res)=>{
            ...
            <div className=" row-6 row-md-6">
                <div className="col-8">
                    <Card style={{ width: '48rem' }} className="bg-dark text-white">
                        ...
                        <Button className="text-white" onClick={handleCreate} variant="primary"><Link to="/Uiscreen">SAVE EDI</Link></Button>
