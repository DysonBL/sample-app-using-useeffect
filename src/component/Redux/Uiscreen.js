    ...
    <>
      <nav className="navbar navbar-dark bg-primary">
        ...
        <Dropdown as={ButtonGroup}>
          <Dropdown.Toggle id="dropdown-custom-1" variant="danger">
            POST ALL
          </Dropdown.Toggle>
          <Dropdown.Menu className="super-colors">
            <Dropdown.Item className="super-colors">
              <Link to="/PostButton"> SWEETS POST</Link>
            </Dropdown.Item>
            <Dropdown.Item className="super-colors">
              {" "}
              <Link to="/JuicePost">JUICE POST</Link>
            </Dropdown.Item>
            <Dropdown.Divider />
          </Dropdown.Menu>
        </Dropdown>{" "}
        ...
        <div className="row h-100 overflow-hide">
          <div className="menu col-6 col-md-4">
            <div className="col-12 ">
              <div className="row ">
                <nav className=" title navbar navbar-dark bg-warning overflow-auto">
                  HUMYY...YUMMYY...Tasty Sweets
                </nav>
                {Products &&
                  Products.map((data) => {
                    return (
                          ...
                          <Card.Body>
                            ...
                            <div className="d-flex ">
                              ...
                              <Button
                                style={{ margin: "2px" }}
                                variant="primary"
                                onClick={(e) => clickRemove(e, data.id)}
                              >
                                DELETE
                              </Button>
                            </div>
          ...
          <div className=" bill col-12 col-sm-6 col-md-8">
            <div className="col-12 ">
              <div className="row ">
                <nav className=" title navbar navbar-dark bg- overflow-auto">
                  COOL..COOL..FRESH JUICE .....Enjoy the dirnk
                </nav>
                {JUICE &&
                  JUICE.map((data) => {
                    return (
